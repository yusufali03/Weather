...
})({"gIPAz":[function(require,module,exports) {
...
// "use strict";
var _renderWeatherInfoJs = require("./renderWeatherInfo.js");
...
const countryWeatherInfo = async function(country) {
    const API = await fetch(`http://api.weatherapi.com/v1/current.json?key=91a3164fcb414f28a53163242230909&q=${country}&aqi=no`).then((res)=>{
        res.json();
    }).then((data)=>{
        console.log(data);
    /* const data = {
    ...
    (0, _renderWeatherInfoJs.countryWeatherInfo)("uzbekistan");
...
},{"./renderWeatherInfo.js":"2pm7r"}],"2pm7r":[function(require,module,exports) {

},{}]},["gIPAz","83FZ8"], "83FZ8", "parcelRequire8fb7")
